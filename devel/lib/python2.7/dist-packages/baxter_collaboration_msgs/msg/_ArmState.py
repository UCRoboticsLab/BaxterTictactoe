...
"""autogenerated by genpy from baxter_collaboration_msgs/ArmState.msg. Do not edit."""
import sys
...
class ArmState(genpy.Message):
  _md5sum = "970438bec580bc76d6e5b3ec112e3e7b"
  _type = "baxter_collaboration_msgs/ArmState"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string state
string action
string object
"""
  __slots__ = ['state','action','object']
