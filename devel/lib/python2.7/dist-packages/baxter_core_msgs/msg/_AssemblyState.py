...
class AssemblyState(genpy.Message):
  _md5sum = "d7ff2b9fa7d5f688665ce44db4ee2af8"
  _type = "baxter_core_msgs/AssemblyState"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool enabled             # true if enabled
...
"""
  ...
  __slots__ = ['enabled','stopped','error','estop_button','estop_source']
  _slot_types = ['bool','bool','bool','uint8','uint8']
